...
const COMBOS = [
  {
    nome: "E: agosto/2026 inteiro + Formulário de Vistoria de Obras (tipo padrao deste repo)",
    servico: "range", inspecao: "range", periodo: ["01/08/2026", "31/08/2026"],
  },
  {
    nome: "F: agosto/2026 inteiro, SEM filtro de tipo (deixa o campo como veio)",
    servico: "range", inspecao: "range", periodo: ["01/08/2026", "31/08/2026"], tipo: null, semTipo: true,
  },
  // Os repos de BA tinham aqui combos com OUTROS tipos de checklist, pra separar
  // "periodo vazio" de "tipo errado". Aqui ainda nao da: a lista de tipos de CE
  // nao foi inspecionada. Depois do primeiro `npm run inspect`, acrescente um
  // combo por tipo vizinho (os que o token "Vistoria de Obras" tambem filtra).
];
