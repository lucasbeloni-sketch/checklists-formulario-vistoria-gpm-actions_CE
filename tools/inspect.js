// Helper de calibracao da tela "Checklists Pergunta/Resposta" (GPM CE).
...
(async () => {
  ...
  if ((process.env.GPM_CE_USER || process.env.GPM_USER) && (process.env.GPM_CE_PASS || process.env.GPM_PASS)) {
